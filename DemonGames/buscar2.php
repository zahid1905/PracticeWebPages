    ...
    <body background="Imagenes/fondo.jpg">
        ...
        <table align="center">
            ...
            <tr>
                ...
                <form action="editar.php?id=<?php echo $row['nombre_p']; ?>" method="post">

                    <td style="text-align:center"><input style="width:90px" type="submit" name="Comprar" value="Editar" class="field"></td>
                
                </form>

                <form action="eliminar.php?nom=<?php echo $row['nombre_p'];?>" method="post">

                    <td style="text-align:center"><input style="width:100px" type="submit" name="Carrito" value="Eliminar" class="field"></td>
