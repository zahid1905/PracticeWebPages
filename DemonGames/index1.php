    ...
    <body background="Imagenes/fondo.jpg">
        ...
        <table align="center">
            ...
            <tr>
                ...
                <form action="db_carrito.php?nom=<?php echo $row['nombre_p'];?>" method="post">

                    <td style="text-align:center"><input style="width:100px" type="submit" name="Carrito" value="Añadir al carrito" class="field"></td>
