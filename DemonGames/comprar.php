    ...
    <body background="Imagenes/fondo.jpg">
        ...
        <table align="center">
            ...
            <?php
                ...
                $query = "SELECT `nombre_p`,`costo`,`cantidad` FROM `productos` WHERE `nombre_p` = '$id'";
            ...
            <tr>
                ...
                <form action="compra.php?id1=<?php echo $row['nombre_p']; ?>&cantida=<?php echo $row['cantidad']; ?>" method="post"><input type="number" class="field" value="1" min="1" max="<?php echo $row['cantidad']; ?>" name="Cantidad"></td>
